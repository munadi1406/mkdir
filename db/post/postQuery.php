...
if ($tipe === 'Movie') {
    ...
    $sql = "INSERT INTO films (id_users, title, `desc`, date, image,tipe) VALUES ($id_users, '$title', '$desc', '$date', '$image','$tipe');";
    ...
    $sql2 = "INSERT INTO episode (film_id,episode) VALUES ($id_films,1)";
    ...
    if (isset($_POST['quality1080']) && $_POST['quality1080'] === '1080') {
        ...
        $utb1080 = $_POST['utb1080'];
        $mg1080 = $_POST['mg1080'];
        $values[] = "('$gd1080', '$utb1080', '$mg1080', '$id_films', '1080',$id_episode)";
    }
    if (isset($_POST['quality720']) && $_POST['quality720'] === '720') {
        $gd720 = $_POST['gd720'];
        $utb720 = $_POST['utb720'];
        $mg720 = $_POST['mg720'];
        $values[] = "('$gd720', '$utb720', '$mg720', '$id_films', '720',$id_episode)";
    }
    if (isset($_POST['quality540']) && $_POST['quality540'] === '540') {
        $gd540 = $_POST['gd540'];
        $utb540 = $_POST['utb540'];
        $mg540 = $_POST['mg540'];
        $values[] = "('$gd540', '$utb540', '$mg540', '$id_films', '540',$id_episode)";
    }
